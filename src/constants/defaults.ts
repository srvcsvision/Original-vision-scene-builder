...
export const TOTAL_WALLS = 6;
export const DEFAULT_WALL_COLORS = ['#1e1e26', '#252530', '#1e1e26', '#252530', '#1e1e26', '#252530'];
export const WALL_LABELS = ['Pared 1', 'Pared 2', 'Pared 3', 'Pared 4', 'Pared 5', 'Pared 6'];
